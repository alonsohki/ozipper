...
<xsl:template match="xml/rounds/number">
  <xsl:text>[b][size=18pt]</xsl:text><xsl:value-of select="." /><xsl:text>[/size][/b]</xsl:text>
</xsl:template>

<xsl:template match="xml/attackers/title|xml/defenders/title">
  <xsl:text>[size=18pt]</xsl:text><xsl:value-of select="." /><xsl:text>[/size]</xsl:text>
</xsl:template>

<xsl:template match="xml/attackers/player/name">
  <xsl:text>[color=#00FF40][b][size=14pt]</xsl:text><xsl:value-of select="." /><xsl:text>[/size][/b]</xsl:text>
</xsl:template>
<xsl:template match="xml/defenders/player/name">
  <xsl:text>[color=#FD8002][b][size=14pt]</xsl:text><xsl:value-of select="." /><xsl:text>[/size][/b]</xsl:text>
</xsl:template>
...
<xsl:template match="xml/winner">
  <xsl:text>[b][size=13pt]</xsl:text><xsl:value-of select="." /><xsl:text>[/size][/b]</xsl:text>
</xsl:template>
...
<xsl:template match="xml/losses/losses[@role = 'attacker']/total/number">
  <xsl:text>[color=#00AA50][size=16pt]</xsl:text><xsl:value-of select="." /><xsl:text>[/size][/color]</xsl:text>
</xsl:template>
...
<xsl:template match="xml/losses/losses[@role = 'defender']/total/number">
  <xsl:text>[color=#ED7010][size=16pt]</xsl:text><xsl:value-of select="." /><xsl:text>[/size][/color]</xsl:text>
</xsl:template>
...
<xsl:template match="xml/losses/losses[@role = 'total']/total/number">
  <xsl:text>[size=18pt][b]</xsl:text><xsl:value-of select="." /><xsl:text>[/b][/size]</xsl:text>
</xsl:template>
...
<xsl:template match="xml/yield/player[@role = 'attacker']/recycling/percent">
  <xsl:text>[color=#00AA50][size=11pt][b]</xsl:text><xsl:value-of select="." /><xsl:text>[/b][/size]</xsl:text>
</xsl:template>

<xsl:template match="xml/yield/player/*/total/number">
  <xsl:text>[size=17pt]</xsl:text><xsl:value-of select="." /><xsl:text>[/size][/color]</xsl:text>
</xsl:template>
...
<xsl:template match="xml/yield/player[@role = 'attacker']/wrecycling/percent">
  <xsl:text>[color=#E6E600][size=11pt][b]</xsl:text><xsl:value-of select="." /><xsl:text>[/b][/size]</xsl:text>
</xsl:template>
...
<xsl:template match="xml/yield/player[@role = 'defender']/recycling/percent">
  <xsl:text>[color=#ED7010][size=11pt][b]</xsl:text><xsl:value-of select="." /><xsl:text>[/b][/size]</xsl:text>
</xsl:template>
...
<xsl:template match="xml/signature/title">
  <xsl:text>[size=9pt][color=orange]</xsl:text><xsl:value-of select="." /><xsl:text>[/color][/size]</xsl:text>
</xsl:template>

<xsl:template match="xml/signature/url">
  <xsl:text>[size=10pt][b][url=</xsl:text><xsl:value-of select="." /><xsl:text>]OZipper[/url][/b][/size]</xsl:text>
</xsl:template>

<xsl:template match="xml/moon/chance">
  <xsl:text>[size=17pt]</xsl:text><xsl:value-of select="." /><xsl:text>[/size]</xsl:text>
</xsl:template>
