...
<xsl:template match="xml/attackers/player/name">
  <xsl:text>[color=#DD0000][b][size=16]</xsl:text><xsl:value-of select="." /><xsl:text>[/size][/b]</xsl:text>
</xsl:template>
<xsl:template match="xml/defenders/player/name">
  <xsl:text>[color=#0000DD][b][size=16]</xsl:text><xsl:value-of select="." /><xsl:text>[/size][/b]</xsl:text>
</xsl:template>
