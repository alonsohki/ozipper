...
<xsl:template match="xml/attackers/title|xml/defenders/title">
  <xsl:text>[size=16pt]</xsl:text><xsl:value-of select="." /><xsl:text>[/size]</xsl:text>
</xsl:template>

<xsl:template match="xml/attackers/player/name">
  <xsl:text>[color=#DD0000][b][size=14pt]</xsl:text><xsl:value-of select="." /><xsl:text>[/size][/b]</xsl:text>
</xsl:template>
<xsl:template match="xml/defenders/player/name">
  <xsl:text>[color=#0000DD][b][size=14pt]</xsl:text><xsl:value-of select="." /><xsl:text>[/size][/b]</xsl:text>
</xsl:template>
...
<xsl:template match="xml/losses/losses[@role = 'attacker']/total/number">
  <xsl:text>[color=#DD0000][size=16pt]</xsl:text><xsl:value-of select="." /><xsl:text>[/size][/color]</xsl:text>
</xsl:template>
...
<xsl:template match="xml/losses/losses[@role = 'defender']/total/number">
  <xsl:text>[color=#0000DD][size=16pt]</xsl:text><xsl:value-of select="." /><xsl:text>[/size][/color]</xsl:text>
</xsl:template>
...
<xsl:template match="xml/yield/player[@role = 'attacker']/recycling/percent">
  <xsl:text>[color=#DD0000][size=11pt][b]</xsl:text><xsl:value-of select="." /><xsl:text>[/b][/size]</xsl:text>
</xsl:template>
...
<xsl:template match="xml/yield/player[@role = 'attacker']/wrecycling/percent">
  <xsl:text>[color=#7B7905][size=11pt][b]</xsl:text><xsl:value-of select="." /><xsl:text>[/b][/size]</xsl:text>
</xsl:template>
...
<xsl:template match="xml/yield/player[@role = 'defender']/recycling/percent">
  <xsl:text>[color=#0000DD][size=11pt][b]</xsl:text><xsl:value-of select="." /><xsl:text>[/b][/size]</xsl:text>
</xsl:template>
...
<xsl:template match="xml/signature/title">
  <xsl:text>[size=9pt][color=#006400]</xsl:text><xsl:value-of select="." /><xsl:text>[/color][/size]</xsl:text>
</xsl:template>
